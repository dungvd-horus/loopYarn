...
public class PaintingGridObject : MonoBehaviour
{
    ...
    public int BatchSetColorByCode(string colorCode, [Bridge.Ref] Color newColor, bool includeHidden = false)
    {
    ...
    private static bool ApproximatelyEqual([Bridge.Ref] Color a, [Bridge.Ref] Color b, float eps = 0.001f)
    {
    ...
    public void InitializeGrid([Bridge.Ref] Vector2 size, float arrangeSpace, GameObject prefab, [Bridge.Ref] Vector3 blockScale, LevelMechanicObjectPrefabs prefabSrc, Material pixelSharedMaterial)
    {
        this.gridSize = size;
    ...
    public void SetupPixelObject(int column, int row, [Bridge.Ref] Color newColor, string colorCode, bool hidden)
    {
    ...
    private Color ApplyColorVariation([Bridge.Ref] Color originalColor, float variationAmount)
    {
    ...
    public (int column, int row, Vector3 pixelPos) GetPredictedPixel([Bridge.Ref] Vector3 pos)
    {
