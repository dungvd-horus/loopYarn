...
namespace GogoGaga.OptimizedRopesAndCables
{
    ...
    public class RopeMesh : MonoBehaviour
    {
        ...
        private bool TrySetSingleColor(Material mat, [Bridge.Ref] Color color)
        {
        ...
        public void SetColor([Bridge.Ref] Color _color)
        {
            if (meshRenderer != null)
            {
        ...
        public void SetColor([Bridge.Ref] Color _firstColor, [Bridge.Ref] Color _secondColor)
        {
