...
public class CollectorAnimation : MonoBehaviour
{
    ...
    public void PlayAnim(Vector3 vector3, CollectorAnimState animState, Action actionOnComplete = null)
    {
    ...
    private void MoveToQueuePosition(Vector3 newPos, Action actionOnComplete = null)
    {
        PlayStretch();
    ...
    private void MoveToQueueRotateBack(Vector3 newPos, Action actionOnComplete = null)
    {
        PlayStretch();
        if (tweenMoveToQueuePosition != null && tweenMoveToQueuePosition.IsActive())
        {
    ...
    private void MoveToDeadPosition(Vector3 newPos, Action actionOnComplete = null)
    {
        StopBreathing();
        if (tweenMoveToQueuePosition != null && tweenMoveToQueuePosition.IsActive())
        {
    ...
    private void MoveToBeltPosition(Vector3 newPos, Action actionOnComplete = null)
    {
        JumpingToBelt = true;
        PlayStretch();
        if (tweenMoveToQueuePosition != null && tweenMoveToQueuePosition.IsActive())
    ...
    private void PushForwardAnimation(Vector3 newPos, Action actionOnComplete = null)
    {
    ...
    private void PushForwardOnQueue(Vector3 newPos, Action actionOnComplete = null)
    {
    ...
    private void UnlockLockObjectAnimation(Vector3 newPos, Action actionOnComplete = null)
    {
        gameObject.SetActive(false);
        actionOnComplete?.Invoke();
    }
